...
IN_FILE = PROJECT_ROOT / "data" / "processed" / "behavioral_hit_trials_features_subject_norm.csv"
OUT_FILE = PROJECT_ROOT / "data" / "processed" / "behavioral_baseline_loso_subject_norm_results.csv"
