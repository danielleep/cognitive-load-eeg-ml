...
OUT_FILE = PROJECT_ROOT / "data" / "processed" / "eeg_baseline_engineered_loso_results.csv"

df = pd.read_csv(IN_FILE)

print("Loaded EEG engineered data:", df.shape)
...
# Use all engineered EEG features.
# This includes:
# - log theta/alpha/beta by region
# - global log band power
# - log band-ratio features
feature_cols = [
...
print(f"\nSaved engineered EEG LOSO results to: {OUT_FILE}")
